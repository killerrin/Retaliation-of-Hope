...
public class Boid : MonoBehaviour {
	...
	public void BoidUpdate () {
		...
		{
			Quaternion rotation = Quaternion.RotateTowards(transform.rotation, Quaternion.LookRotation(new Vector3(Velocity.x, Velocity.y, Velocity.z)), Time.deltaTime * RotateSpeed);

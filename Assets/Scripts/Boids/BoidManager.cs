...
public class BoidManager : MonoBehaviour {
	...
	public void SpawnBoids(int num)
	{
		...
		{
			spawnPos = new Vector3((float)ConstManager.random.Next((int)-boundries.x, (int)boundries.x),
								   (float)ConstManager.random.Next((int)-boundries.y, (int)boundries.y),
								   (float)ConstManager.random.Next((int)-boundries.z, (int)boundries.z));
		}
